...
/*
    Without LIBXML_NOEMPTYTAG to expand all self-closing tags, the result will be malformed.
*/
// echo (buildDocument($root)->saveXML(null));

echo (buildDocument($root)->saveXML(null, LIBXML_NOCDATA  | LIBXML_NOEMPTYTAG));

function buildDocument(DOMDocument $doc): DOMDocument {
    global $fragHTML;
    $doc->loadHTMLFile($fragHTML, LIBXML_NOCDATA | LIBXML_HTML_NOIMPLIED | LIBXML_HTML_NODEFDTD);
